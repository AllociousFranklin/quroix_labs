      ...
      <article className="casestudy">
        <div className="casestudy-content">
          <div className="casestudy-top">
            ...
            <div className="casestudy-top-section">
              <img src="/mockups/trielement.webp" className="casestudy-video" alt="BIM Engineering Studio website showcasing architectural visualization services" />
            </div>
            <div className="casestudy-top-gradient" />
            <img src="/mockups/trielement.webp" ref={imageRef} className="casestudy-top-image" alt="BIM Engineering Studio parallax background" />
          </div>
          ...
          <div className="casestudy-bottom">
            <div className="casestudy-bottom-full-imagebox" ref={casestudyImageRef1} >
              <img src="/mockups/trielement.webp" className="casestudy-bottom-image" alt="BIM Engineering Studio full desktop website view" />
            </div>
            <div className="casestudy-bottom-half-imagebox" ref={casestudyImageRef2} >
              <img src="/images/test18.webp" className="casestudy-bottom-image" alt="BIM Engineering Studio architectural workflow interface" />
            </div>
            <div className="casestudy-bottom-half-imagebox" ref={casestudyImageRef3} >
              <img src="/images/test19.webp" className="casestudy-bottom-image" alt="BIM Engineering Studio grid system and data visualization" />
            </div>
          </div>
        </div>
      </article>
