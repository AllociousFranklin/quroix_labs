      ...
      <section className="casestudy">
        <div className="casestudy-content">
          <div className="casestudy-top">
            ...
            <div className="casestudy-top-section">
              <img src="/mockups/heave.webp" className="casestudy-video" alt="Apex Gym Hero" />
            </div>
          ...
          <div className="casestudy-bottom">
            <div className="casestudy-bottom-full-imagebox" ref={casestudyImageRef1} >
              <img src="/mockups/heave.webp" className="casestudy-bottom-image" alt="Gym Landing Page" />
            </div>
            <div className="casestudy-bottom-half-imagebox" ref={casestudyImageRef2} >
              <img src="/images/test17.webp" className="casestudy-bottom-image" alt="Vibrant Design" />
            </div>
            <div className="casestudy-bottom-half-imagebox" ref={casestudyImageRef3} >
              <img src="/images/test14.webp" className="casestudy-bottom-image" alt="Operational Flow" />
            </div>
          </div>
        </div>
      </section>
