      ...
      <article className="casestudy">
        <div className="casestudy-content">
          <div className="casestudy-top">
            ...
            <div className="casestudy-top-section">
              <img src="/mockups/trielementdesign.webp" className="casestudy-video" alt="MEP Design Consultants website homepage showcasing engineering services and global project portfolio" />
            </div>
            <div className="casestudy-top-gradient" />
            <img src="/mockups/trielementdesign.webp" ref={imageRef} className="casestudy-top-image" alt="MEP Design Consultants parallax background" />
          </div>
          ...
          <div className="casestudy-bottom">
            <div className="casestudy-bottom-full-imagebox" ref={casestudyImageRef1} >
              <img src="/mockups/trielementdesign.webp" className="casestudy-bottom-image" alt="MEP Design Consultants full desktop website view showing services and project portfolio" />
            </div>
            <div className="casestudy-bottom-half-imagebox" ref={casestudyImageRef2} >
              <img src="/images/test14.webp" className="casestudy-bottom-image" alt="MEP Design Consultants technical page layout with engineering specifications" />
            </div>
            <div className="casestudy-bottom-half-imagebox" ref={casestudyImageRef3} >
              <img src="/images/test17.webp" className="casestudy-bottom-image" alt="MEP Design Consultants mobile responsive website experience" />
            </div>
          </div>
        </div>
      </article>
